...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{0}
}
...
type BatchCommandsRequest_Request struct {
	...
	//	*BatchCommandsRequest_Request_Write
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{0, 0}
}
...
type BatchCommandsRequest_Request_Write struct {
	Write *kvrpcpb.WriteRequest `protobuf:"bytes,34,opt,name=write,oneof"`
}
...
func (*BatchCommandsRequest_Request_Write) isBatchCommandsRequest_Request_Cmd()               {}
...
func (m *BatchCommandsRequest_Request) GetWrite() *kvrpcpb.WriteRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_Write); ok {
		return x.Write
	}
	return nil
}
...
func (*BatchCommandsRequest_Request) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsRequest_Request_OneofMarshaler, _BatchCommandsRequest_Request_OneofUnmarshaler, _BatchCommandsRequest_Request_OneofSizer, []interface{}{
		...
		(*BatchCommandsRequest_Request_Write)(nil),
...
func _BatchCommandsRequest_Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsRequest_Request_Write:
...
func _BatchCommandsRequest_Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 34: // cmd.write
		...
		msg := new(kvrpcpb.WriteRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_Write{msg}
		return true, err
	case 255: // cmd.Empty
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{1}
}
...
type BatchCommandsResponse_Response struct {
	...
	//	*BatchCommandsResponse_Response_Write
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{1, 0}
}
...
type BatchCommandsResponse_Response_Write struct {
	Write *kvrpcpb.WriteResponse `protobuf:"bytes,34,opt,name=write,oneof"`
}
...
func (*BatchCommandsResponse_Response_Write) isBatchCommandsResponse_Response_Cmd()               {}
...
func (m *BatchCommandsResponse_Response) GetWrite() *kvrpcpb.WriteResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_Write); ok {
		return x.Write
	}
	return nil
}
...
func (*BatchCommandsResponse_Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsResponse_Response_OneofMarshaler, _BatchCommandsResponse_Response_OneofUnmarshaler, _BatchCommandsResponse_Response_OneofSizer, []interface{}{
		...
		(*BatchCommandsResponse_Response_Write)(nil),
...
func _BatchCommandsResponse_Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsResponse_Response_Write:
		_ = b.EncodeVarint(34<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Write); err != nil {
			return err
		}
...
func _BatchCommandsResponse_Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 34: // cmd.write
		...
		msg := new(kvrpcpb.WriteResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_Write{msg}
		return true, err
	case 255: // cmd.Empty
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{2}
}
...
func (*BatchCommandsEmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{3}
}
...
func (*BatchCommandsEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_61378d267586c4ac, []int{4}
}
...
type TikvClient interface {
	...
	KvWrite(ctx context.Context, in *kvrpcpb.WriteRequest, opts ...grpc.CallOption) (*kvrpcpb.WriteResponse, error)
...
func (c *tikvClient) KvWrite(ctx context.Context, in *kvrpcpb.WriteRequest, opts ...grpc.CallOption) (*kvrpcpb.WriteResponse, error) {
	out := new(kvrpcpb.WriteResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/KvWrite", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	KvWrite(context.Context, *kvrpcpb.WriteRequest) (*kvrpcpb.WriteResponse, error)
	// Raw commands; no transaction support.
...
func _Tikv_KvWrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.WriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).KvWrite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/KvWrite",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).KvWrite(ctx, req.(*kvrpcpb.WriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *BatchCommandsRequest_Request_Write) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Write != nil {
		dAtA[i] = 0x92
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Write.Size()))
		n37, err := m.Write.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *BatchCommandsResponse_Response_Write) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Write != nil {
		dAtA[i] = 0x92
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Write.Size()))
		n75, err := m.Write.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n75
...
func (m *BatchCommandsRequest_Request_Write) Size() (n int) {
	var l int
	_ = l
	if m.Write != nil {
		l = m.Write.Size()
...
func (m *BatchCommandsResponse_Response_Write) Size() (n int) {
	var l int
	_ = l
	if m.Write != nil {
		l = m.Write.Size()
...
func (m *BatchCommandsRequest_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			...
			v := &kvrpcpb.WriteRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_Write{v}
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
...
func (m *BatchCommandsResponse_Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			...
			v := &kvrpcpb.WriteResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_Write{v}
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Empty", wireType)
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_61378d267586c4ac) }

var fileDescriptor_tikvpb_61378d267586c4ac = []byte{
	...
	,
}
